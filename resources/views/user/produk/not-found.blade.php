...
<head>
    ...
    <title>404 - Toko Tidak Tersedia</title>
    ...
    <link rel="stylesheet" href="{{ url('mazer/assets/css/pages/error.css')}}">
</head>
    ...
    <div id="error">
        ...
        <div class="error-page container">
            <div class="col-md-8 col-12 offset-md-2">
                <img class="img-error" src="{{ url('mazer/assets/images/samples/error-404.png')}}" alt="Not Found">
                <div class="text-center">
                    <h1 class="error-title">NOT FOUND</h1>
                    <p class='fs-5 text-gray-600'>Toko Tidak Tersedia.</p>
