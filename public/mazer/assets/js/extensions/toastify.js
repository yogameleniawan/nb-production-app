...
var defaultBackroundColor = "linear-gradient(to right, #00b09b, #96c93d)"

function toast(text = "", gravity = "bottom", position = "right", backgroundColor = defaultBackroundColor, duration = 1500, close = false) {
    Toastify({
        text: text,
        duration: duration,
        close: close,
